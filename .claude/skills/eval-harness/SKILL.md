---
name: eval-harness
description: Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD) principles. Use this skill proactively when the user wants to define success criteria before coding, set up regression tests, measure agent reliability with pass@k metrics, benchmark agent performance, or track behavior quality across model or prompt changes — even if they don't explicitly say "eval" or "EDD."
origin: ECC
